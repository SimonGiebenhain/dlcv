...
W_fc1 = weight_variable('w_fc_1', [7 * 7 * 64, 1024], True)
b_fc1 = bias_variable('b_fc_1',[1024], True)
...
W_fc2 = weight_variable('w_fc_2', [1024, 10], True)
b_fc2 = bias_variable('b_fc_2', [10], True)
...
with tf.Session() as sess:
    ...
    sess.run(W_fc1.initializer)
    sess.run(b_fc1.initializer)
    sess.run(W_fc2.initializer)
    sess.run(b_fc2.initializer)

    print("\nNow the trainable Variables:")
