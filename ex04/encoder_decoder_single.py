...
lat_actual = tf.gather(examples, Y)
...
def train():
    with tf.Session() as sess:
        ...
        for i in range(10000):
            ...
            if i % 500 == 0 and i > 0:
                saver.save(sess, "/Users/sigi/PycharmProjects/ex04/weights_encoder_decoder_4.ckpt")
...
def display():
    ...
    with tf.Session() as sess:
        #sess.run(tf.global_variables_initializer())
        #sess.run(tf.variables_initializer(tf.get_collection('vars')))
        saver.restore(sess, "/Users/sigi/PycharmProjects/ex04/weights_encoder_decoder_4.ckpt")
